    ...
    <nav class="navbar navbar-static-top" role="navigation">
      ...
      <div class="navbar-custom-menu">
        ...
        @endauth
          ...
          <li>
          <a href="{{route('admin-profile')}}"><i class="fas fa-cogs"></i></a>
          </li>
        </ul>
      </div>
    </nav>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="{{route('admin-home')}}"><i class="fas fa-home"></i> <span>Home</span></a></li>
        <li class="treeview">
            <a href="#"><i class="fas fa-cubes"></i> <span>Create categories</span>
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="{{route('category.create')}}">Create new subject category</a></li>
              <li><a href="#">Create new Sub model</a></li>
...
<!-- Optionally, you can add Slimscroll and FastClick plugins.
     Both of these plugins are recommended to enhance thes
     user experience. -->
