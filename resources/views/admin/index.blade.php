...
@section('content')
  ...
  <div class="row">
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box">
        <span class="info-box-icon bg-aqua"><i class="fas fa-comments"></i></span>

        <div class="info-box-content">
          <span class="info-box-text">Discussions</span>
          <span class="info-box-number">{{$discussions->count()}}</small></span>
        </div>
        <!-- /.info-box-content -->
      </div>
      <!-- /.info-box -->
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box">
        <span class="info-box-icon bg-red"><i class="fas fa-poll-h"></i></i></span>

        <div class="info-box-content">
          <span class="info-box-text">Examsurveys</span>
          <span class="info-box-number">{{$examsurveys->count()}}</span>
        </div>
        <!-- /.info-box-content -->
      </div>
      <!-- /.info-box -->
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box">
        <span class="info-box-icon bg-green"><i class="fas fa-question"></i></span>
  ...
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="box box-danger">
        ...
        <div class="box-body">
          <canvas id="pieChart" style="height: 173px; width: 347px;" height="346" width="694"></canvas>
        </div>
        <!-- /.box-body -->
      </div>
      <!-- /.box -->
    ...
    <div class="col-md-6">
      ...
      <div class="box box-info">
        ...
        <div class="box-body">
          <div class="chart">
            <canvas id="lineChart" style="height: 185px; width: 347px;" height="370" width="694"></canvas>
          </div>
        </div>
        <!-- /.box-body -->
      </div>
